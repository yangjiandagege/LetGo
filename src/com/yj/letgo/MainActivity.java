...
public class MainActivity extends BaseActivity{
	public BtPerform[] initButtons(){
		...
		int i = -1;
		btPerform[++i] = new BtPerform("Common test", i, Color.CYAN, MainActivity.this, com.yj.letgo.common.MainActivity.class);
		btPerform[++i] = new BtPerform("AIDL", i, Color.CYAN, MainActivity.this, com.yj.letgo.aidl.ClientActivity.class);
		btPerform[++i] = new BtPerform("Binder pool", i, Color.CYAN, MainActivity.this, com.yj.letgo.binderpool.BinderPoolActivity.class);
		btPerform[++i] = new BtPerform("Bitmap", i, Color.CYAN, MainActivity.this, com.yj.letgo.bitmap.MainActivity.class);
		btPerform[++i] = new BtPerform("BLE central", i, Color.CYAN, MainActivity.this, com.yj.letgo.ble.central.CentralActivity.class);
		btPerform[++i] = new BtPerform("BLE peripheral", i, Color.CYAN, MainActivity.this, com.yj.letgo.ble.peripheral.PeripheralActivity.class);
		btPerform[++i] = new BtPerform("ViewPager demo", i, Color.CYAN, MainActivity.this, com.yj.letgo.viewpager.MainActivity.class);
		btPerform[++i] = new BtPerform("Content observer", i, Color.CYAN, MainActivity.this, com.yj.letgo.contentobserver.MainActivity.class);
		btPerform[++i] = new BtPerform("Content provider", i, Color.CYAN, MainActivity.this, com.yj.letgo.contentprovider.TeacherActivity.class);
		...
		btPerform[++i] = new BtPerform("DIY ViewGroup : My ViewPager", i, Color.CYAN, MainActivity.this, com.yj.letgo.diyviews.slidingconflict.MainActivity.class);
		btPerform[++i] = new BtPerform("DIY ViewGroup : SlideMenu", i, Color.CYAN, MainActivity.this, com.yj.letgo.diyviews.slidemenu.SlideMenuActivity.class);
